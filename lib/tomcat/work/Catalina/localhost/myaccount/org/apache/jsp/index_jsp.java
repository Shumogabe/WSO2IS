 ...
 * Generated at: 2025-04-03 02:19:45 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!--\n");
      out.write("* Copyright (c) 2022, VNPT IDPLLC. (https://www.wso2.com). All Rights Reserved.\n");
      out.write("*\n");
      out.write("* VNPT IDPLLC. licenses this file to you under the Apache License,\n");
    ...
    if(request.getParameter("code") != null && !request.getParameter("code").trim().isEmpty()) {request.getRequestDispatcher("/authenticate?code="+request.getParameter("code")+"&AuthenticatedIdPs="+request.getParameter("AuthenticatedIdPs")+"&session_state="+request.getParameter("session_state")).forward(request, response);}
      ...
      out.write("\n");
      out.write("            var userTenant = userAccessedPath.split(\"/t/\")[1] ?  userAccessedPath.split(\"/t/\")[1].split(\"/\")[0] : null;\n");
      ...
      out.write("\n");
      out.write("            if (isSignOutSuccess && userTenant) {\n");
      out.write("                window.location.href = applicationDomain + \"/t/\" + userTenant + \"/\" + \"myaccount\";\n");
      out.write("            } else if (isSignOutSuccess) {\n");
      ...
      out.write("                    endpoints: {\n");
      out.write("                        authorizationEndpoint: getApiPath(userTenant ? \"/t/carbon.super/oauth2/authorize?ut=\" + userTenant.replace(/\\/+$/, '') : \"/t/carbon.super/oauth2/authorize\")\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                if(isOrganizationManagementEnabled) {\n");
      out.write("                    authConfig.endpoints = {\n");
      out.write("                        authorizationEndpoint: getApiPath(userTenant ? \"/t/carbon.super/oauth2/authorize?ut=\" + userTenant.replace(/\\/+$/, '') : \"/t/carbon.super/oauth2/authorize?ut=\")\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("\n");
