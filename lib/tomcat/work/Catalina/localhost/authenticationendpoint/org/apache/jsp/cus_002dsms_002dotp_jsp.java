 ...
 * Generated at: 2025-04-08 09:40:41 UTC
...
public final class cus_002dsms_002dotp_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (new File(getServletContext().getRealPath("extensions/timeout.jsp")).exists()) { 
      ...
      try {
        ...
        // /cus-sms-otp.jsp(111,0) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /cus-sms-otp.jsp(111,0) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /cus-sms-otp.jsp(111,0) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /cus-sms-otp.jsp(112,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /cus-sms-otp.jsp(125,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("                ");
                  out.write("\n");
                  out.write("            <p style=\"font-size: 200%\">Xác thực SMS OTP</p>\n");
                  out.write("            <p id=\"CUSTOM_SMS_AUTHENTICATOR_RESPONSE\" style=\"font-size: 110%\">Mã xác nhận đã được gửi qua SĐT của bạn <b>");
                  out.print(encodeMobileNumber((String) FrameworkUtils.getContextData(request).getProperty("CUSTOM_SMS_AUTHENTICATOR_RESPONSE")));
                  out.write("</b></p>\n");
                  out.write("            <div class=\"ui negative message\" id=\"failed-msg\"></div>\n");
                  out.write("            <div class=\"ui divider hidden\"></div>\n");
                  out.write("            <div id=\"alertDiv\"></div>\n");
                  out.write("            <div class=\"segment-form\">\n");
                  out.write("                <form class=\"ui large form\" id=\"custom_sms_otp_form\" action=\"");
                  out.print(commonauthURL);
                  out.write("\" method=\"POST\">\n");
                  out.write("                    <input type=\"text\" name=\"custom_sms_otp\" id=\"custom_sms_otp\" hidden>\n");
                  out.write("                    <input type='hidden' name='custom_resend_sms_otp' value='false' id=\"custom_resend_sms_otp\"/>\n");
                  ...
                  out.write("                        <p style=\"margin: auto; padding: 15px ; display: none\" id=\"resendOtp\">Bạn chưa nhận được mã?<a style=\"cursor: pointer\" onclick=\"resendCode()\"> Gửi lại OTP</a></p>\n");
                  out.write("                    </div>\n");
            ...
            try {
              ...
              // /cus-sms-otp.jsp(165,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (footerFile.exists()) {
      ...
      out.write("        $(\"#custom_resend_sms_otp\").val(\"true\");\n");
      out.write("        document.getElementById(\"custom_sms_otp_form\").submit();\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function submitForm() {\n");
      out.write("        $(\"#custom_sms_otp\").val(getOtp());\n");
      out.write("        document.getElementById(\"custom_sms_otp_form\").submit();\n");
      out.write("    }\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("    const SMS = '");
      out.print(FrameworkUtils.getContextData(request).getProperty("CUSTOM_SMS_AUTHENTICATOR_RESPONSE"));
      out.write("';\n");
      ...
      out.write("    } else if (SMS === \"null\" || SMS.trim()===\"\") {\n");
      out.write("        showMessage(\"Bạn cần thêm phương thức bằng SMS!\");\n");
      out.write("        document.getElementById(\"CUSTOM_SMS_AUTHENTICATOR_RESPONSE\").style.display=\"none\";\n");
      out.write("        document.getElementById(\"custom_sms_otp_form\").style.display=\"none\";\n");
