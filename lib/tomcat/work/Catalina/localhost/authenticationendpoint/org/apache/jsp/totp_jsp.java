 ...
 * Generated at: 2025-04-03 02:19:43 UTC
...
public final class totp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("org.wso2.carbon.user.api.UserRealm");
    ...
    _jspx_imports_classes.add("org.wso2.carbon.identity.application.authenticator.totp.exception.TOTPException");
    ...
    _jspx_imports_classes.add("org.wso2.carbon.identity.application.authentication.framework.model.AuthenticatedUser");
 ...
 if (new File(getServletContext().getRealPath("extensions/timeout.jsp")).exists()) { 
      ...
      try {
        ...
        // /totp.jsp(156,0) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /totp.jsp(156,0) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /totp.jsp(156,0) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /totp.jsp(157,0) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (!new File(getServletContext().getRealPath(productTitleFilePath)).exists()) {
            ...
            try {
              ...
              // /totp.jsp(170,0) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("\">\n");
                  out.write("                    <div style=\"display: flex; justify-content: space-around ;margin-top: 30px\">\n");
                  out.write("                        ");
                  ...
                  out.write("'/>\n");
                  out.write("                <div class=\"ui divider hidden\"></div>\n");
                  out.write("                <div class=\"ui two column stackable grid\" style=\"display: flex; flex-direction: column-reverse\">\n");
                  out.write("\n");
                  out.write("                    <div class=\"ten wide column mobile center aligned tablet left aligned computer left aligned buttons tablet computer\" style=\"width: 100% !important\">\n");
                  out.write("                        ");
 if (isSendVerificationCodeByEmailEnabled) { 
                  out.write("\n");
                  out.write("                        <a class=\"ui\" id=\"genToken\" href=\"#\"\n");
                  ...
                  out.write("\n");
                  out.write("                    </div>\n");
                  out.write("                    <div style=\"width: 100% !important\" class=\"six wide column mobile center aligned tablet right aligned computer right aligned buttons tablet no-margin-right-last-child computer no-margin-right-last-child\">\n");
                  out.write("                        <input style=\"width: 100% !important\" type=\"submit\" value=\"");
            ...
            try {
              ...
              // /totp.jsp(249,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("    const lengthOfOTP =");
      out.print(VNPT_lengthOfOtp);
      out.write(";\n");
      ...
      out.write("            const tokenInput = document.querySelector('input[name=\"token\"]');\n");
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    document.querySelector('input[name=\"token\"]').style.display = 'none';\n");
      out.write("\n");
      out.write("    document.getElementById(\"totpForm\").addEventListener(\"submit\", function () {\n");
      out.write("        const tokenInput = document.querySelector('input[name=\"token\"]');\n");
      out.write("        tokenInput.value = getOtp();\n");
      out.write("    });\n");
      out.write("\n");
      out.write("\n");
      out.write("    const enableTOTPButton = \"");
      out.print(isEnabled);
      out.write("\";\n");
      out.write("    if (enableTOTPButton === \"false\") {\n");
      out.write("        document.querySelector(\"#totpForm\").style.display = \"none\";\n");
      out.write("        document.getElementsByTagName(\"h2\")[0].style.textTransform = \"none\";\n");
      out.write("        document.getElementsByTagName(\"h2\")[0].style.fontWeight = \"400\";\n");
      out.write("        document.getElementsByTagName(\"h2\")[0].innerHTML = \"Bạn chưa kích hoạt TOTP!\";\n");
      out.write("\n");
      out.write("    }\n");
      out.write("\n");
      out.write("</script>\n");
