 ...
 * Generated at: 2025-04-14 02:11:17 UTC
...
public final class cus_002demail_002dotp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/lib/taglibs-standard-impl-1.2.5.jar", Long.valueOf(1742872345000L));
    ...
    _jspx_dependants.put("jar:file:/opt/wso2is-tnmt/repository/deployment/server/webapps/authenticationendpoint/WEB-INF/lib/taglibs-standard-impl-1.2.5.jar!/META-INF/fmt.tld", Long.valueOf(1425953470000L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (request.getParameter("reCaptcha") != null && Boolean.parseBoolean(request.getParameter("reCaptcha"))) {
      ...
      out.write("\n");
      out.write("    <script src=\"https://recaptcha.net/recaptcha/api.js\" async defer></script>\n");
      out.write("    ");
 ...
 if (new File(getServletContext().getRealPath("extensions/timeout.jsp")).exists()) { 
      ...
      try {
        ...
        // /cus-email-otp.jsp(116,0) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /cus-email-otp.jsp(116,0) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /cus-email-otp.jsp(116,0) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /cus-email-otp.jsp(117,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /cus-email-otp.jsp(130,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("                ");
                  out.write("\n");
                  out.write("            <p style=\"font-size: 200%\">Xác thực EMAIL OTP</p>\n");
                  out.write("                    <p style=\"font-size: 110%\" id=\"CUSTOM_EMAIL_AUTHENTICATOR_RESPONSE\">Mã xác nhận đã được gửi qua Email của bạn\n");
                  out.write("                        <b style=\"margin-top: 10px\">");
                  out.print(encodeEmail((String) FrameworkUtils.getContextData(request).getProperty("CUSTOM_EMAIL_AUTHENTICATOR_RESPONSE")));
                  out.write("</b>\n");
                  out.write("                    </p>\n");
                  out.write("            <div class=\"ui negative message\" id=\"failed-msg\">Mã OTP không đúng hoặc quá thời hạn</div>\n");
                  out.write("            <div class=\"ui divider hidden\"></div>\n");
                  out.write("            <div id=\"alertDiv\"></div>\n");
                  out.write("            <div class=\"segment-form\">\n");
                  out.write("                <form class=\"ui large form\" id=\"custom_email_otp_form\" action=\"");
                  out.print(commonauthURL);
                  out.write("\" method=\"POST\">\n");
                  out.write("                    <input type=\"text\" name=\"custom_email_otp\" id=\"custom_email_otp\" hidden>\n");
                  out.write("                    <input type='hidden' name='custom_resend_email_otp' value='false' id=\"custom_resend_email_otp\"/>\n");
                  out.write("                    <input value=\"");
                  out.print(request.getParameter("sessionDataKey"));
                  out.write("\" name=\"sessionDataKey\" hidden>\n");
                  out.write("                    <div style=\"display: flex; justify-content: space-around ;margin-top: 15px\">\n");
                  out.write("                        ");

                            {
                                for (int i = 0; i < 6; i++) {
                        
                  out.write("<input type=\"number\" style=\"width: 44px\" maxlength=\"1\" id=\"otp_");
                  out.print(i);
                  out.write('"');
                  out.write('>');
                  ...
                  out.write("\n");
                  out.write("                    </div>\n");
                  out.write("                    <div style=\"display: flex; flex-direction: column; margin-top: 15px; justify-items: center\">\n");
                  ...
                  out.write("\"\n");
                  out.write("                               class=\"ui primary button\" onclick=\"submitForm()\" style=\"width: 100%\"/>\n");
                  out.write("                        <p id=\"resendOtp\" style=\"margin: auto; padding: 15px; display: none\">Bạn chưa nhận được mã?<a style=\"cursor: pointer\" onclick=\"resendCode()\"> Gửi lại OTP</a></p>\n");
                  out.write("                    </div>\n");
                  out.write("                    <div id=\"timer\" style=\"margin: 15px 0; display: flex; justify-content: center\"></div>\n");
                  out.write("                </form>\n");
                  out.write("\n");
            ...
            try {
              ...
              // /cus-email-otp.jsp(172,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (footerFile.exists()) {
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("    const lengthOfOTP = 6;\n");
      out.write("    document.getElementById('otp_0').focus();\n");
      out.write("    for (let i = 0; i < lengthOfOTP; i++) {\n");
      out.write("        document.getElementById('otp_' + i).addEventListener(\"keyup\", function (event) {\n");
      out.write("            if (event.keyCode === 8 || event.keyCode === 46) {\n");
      out.write("                if (this.value.length === 0) focusBack(i);\n");
      out.write("            }\n");
      out.write("            else if (event.key===\"ArrowLeft\" || event.key===\"ArrowDown\") {\n");
      out.write("                focusBack(i);\n");
      out.write("            }\n");
      out.write("            else if (event.key===\"ArrowRight\" || event.key===\"ArrowUp\") {\n");
      out.write("                focusNext(i);\n");
      out.write("            }\n");
      out.write("            else if (this.value.length >= 1) {\n");
      out.write("                focusNext(i);\n");
      out.write("            }\n");
      out.write("        });\n");
      out.write("        document.getElementById('otp_' + i).addEventListener(\"input\", function (event) {\n");
      out.write("            const tokenInput = document.querySelector('input[name=\"OTPCode\"]');\n");
      out.write("            tokenInput.value = getOtp();\n");
      out.write("        });\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function focusBack(index) {\n");
      out.write("        if (index > 0) {\n");
      out.write("            document.getElementById('otp_' + (index - 1)).focus();\n");
      out.write("            document.getElementById('otp_' + (index - 1)).select();\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function focusNext(index) {\n");
      out.write("        if (index < lengthOfOTP - 1) {\n");
      out.write("            document.getElementById('otp_' + (index + 1)).focus();\n");
      out.write("            document.getElementById('otp_' + (index + 1)).click();\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function getOtp() {\n");
      out.write("        let otp = \"\";\n");
      out.write("        for (let i = 0; i < lengthOfOTP; i++) otp += document.getElementById('otp_' + i).value;\n");
      out.write("        return otp;\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function validateForm(){\n");
      out.write("        for (let i = 0; i < lengthOfOTP; i++) {\n");
      out.write("            if (document.getElementById('otp_' + i).value === \"\") {\n");
      out.write("                document.getElementById('otp_' + i).focus();\n");
      out.write("                document.getElementById('otp_' + i).select();\n");
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    function resendCode() {\n");
      out.write("        $(\"#custom_resend_email_otp\").val(\"true\");\n");
      out.write("        document.getElementById(\"custom_email_otp_form\").submit();\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function submitForm() {\n");
      out.write("        $(\"#custom_email_otp\").val(getOtp());\n");
      out.write("        document.getElementById(\"custom_email_otp_form\").submit();\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function showMessage(message){\n");
      out.write("        document.getElementById(\"failed-msg\").style.display=\"block\";\n");
      out.write("        document.getElementById(\"failed-msg\").innerText=message;\n");
      out.write("    }\n");
      out.write("\n");
      out.write("\n");
      out.write("    document.getElementById(\"failed-msg\").style.display=\"none\";\n");
      out.write("    const MAIL = '");
      out.print(FrameworkUtils.getContextData(request).getProperty("CUSTOM_EMAIL_AUTHENTICATOR_RESPONSE"));
      out.write("';\n");
      out.write("    const CODE = '");
      out.print(FrameworkUtils.getContextData(request).getProperty("CUS_CODE"));
      out.write("';\n");
      out.write("    if(\"INVALID_OTP\".includes(CODE)){\n");
      out.write("        showMessage(\"Mã OTP không đúng hoặc quá thời hạn!\");\n");
      out.write("    }\n");
      out.write("    else if(MAIL===\"null\" || MAIL.trim()===\"\"){\n");
      out.write("        showMessage(\"Bạn cần thêm phương thức bằng Email!\");\n");
      out.write("        document.getElementById(\"CUSTOM_EMAIL_AUTHENTICATOR_RESPONSE\").style.display=\"none\";\n");
      out.write("        document.getElementById(\"custom_email_otp_form\").style.display=\"none\";\n");
      out.write("\n");
      out.write("    }\n");
      out.write("    else if(\"SEND_OTP_FAILED\".includes(CODE)){\n");
      out.write("        showMessage(\"Thông báo: Lỗi khi gửi OTP!\")\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    const creationTime = new Date(\"");
      out.print(FrameworkUtils.getContextData(request).getProperty("CREATION_TIME"));
      out.write("\");\n");
      out.write("    const durationExpiration = ");
      out.print(FrameworkUtils.getContextData(request).getProperty("DURATION_TIME"));
      out.write(' ');
      out.write('?');
      out.write(' ');
      out.print(FrameworkUtils.getContextData(request).getProperty("DURATION_TIME"));
      out.write(" : 0;\n");
      out.write("    const interval = setInterval(function(){\n");
      out.write("        const currentTime = new Date();\n");
      out.write("        const timeDiff = Math.abs(currentTime.getTime() - creationTime.getTime());\n");
      out.write("        if(timeDiff >= durationExpiration) {\n");
      out.write("            clearInterval(interval);\n");
      out.write("            document.getElementById(\"timer\").style.display = \"none\";\n");
      out.write("            document.getElementById(\"resendOtp\").style.display = \"block\";\n");
      out.write("        }\n");
      out.write("        else{\n");
      out.write("            const timeDiffSeconds = (durationExpiration - timeDiff)/1000;\n");
      out.write("            const minutes = Math.floor(timeDiffSeconds / 60);\n");
      out.write("            const seconds = Math.floor(timeDiffSeconds % 60);\n");
      out.write("            const formattedMinutes = minutes.toString().padStart(2, '0');\n");
      out.write("            const formattedSeconds = seconds.toString().padStart(2, '0');\n");
      out.write("            const formattedTime = formattedMinutes + \":\" + formattedSeconds;\n");
      out.write("            document.getElementById(\"timer\").innerHTML = \"Thời gian hiệu lực của mã<b style='margin: 0 5px'>\"+ formattedTime +\"</b>\";\n");
      out.write("        }\n");
      out.write("    },1000);\n");
      out.write("\n");
      out.write("</script>\n");
