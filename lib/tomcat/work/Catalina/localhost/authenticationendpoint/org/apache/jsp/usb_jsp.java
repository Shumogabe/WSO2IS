 ...
 * Generated at: 2025-04-10 04:28:53 UTC
...
public final class usb_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    layoutData.put("containerSize", "medium");
      ...
      try {
        ...
        // /usb.jsp(42,0) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /usb.jsp(42,0) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /usb.jsp(42,0) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /usb.jsp(43,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /usb.jsp(56,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("            <h4>USB ký số</h4>\n");
                  out.write("            <p class=\"center\">\n");
                  out.write("                Tải công cụ ký điện tử trên Windows\n");
                  out.write("                <a href=\"https://dangkyid.monre.gov.vn/statics/plugin/VGCASignServiceSetup.msi\" target=\"_blank\" class=\"main\"> tại đây</a>\n");
                  out.write("                hoặc MacOS <a href=\"https://dangkyid.monre.gov.vn/statics/plugin/VGCA_VCTKInstaller.pkg\" target=\"_blank\" class=\"main\"> tại đây</a>\n");
                  out.write("            </p>\n");
                  out.write("            <div class=\"ui divider hidden\"></div>\n");
                  out.write("            <div class=\"error-msg\"></div>\n");
                  out.write("            <div class=\"ui divider hidden\"></div>\n");
                  out.write("            <div class=\"segment-form\">\n");
                  out.write("                <form class=\"ui large form\" id=\"usb_login_form\" name=\"pin_form\" action=\"../commonauth\" method=\"POST\">\n");
                  out.write("                    <input id=\"serial\" name=\"serial\" type=\"hidden\">\n");
                  out.write("                    <input id=\"signedData\" name=\"signedData\" type=\"hidden\">\n");
                  out.write("                    <input id=\"dataBeforeSign\" name=\"dataBeforeSign\" type=\"hidden\">\n");
                  out.write("                    <input id=\"sessionDataKey\" value=\"");
                  out.print(request.getParameter("sessionDataKey"));
                  out.write("\" name=\"sessionDataKey\" hidden>\n");
                  out.write("                    <div class=\"align-center buttons\">\n");
                  out.write("                        <input type=\"button\" style=\"width: 100%\"  name=\"authenticate\" id=\"usb_login_button\" value=\"");
            ...
            try {
              ...
              // /usb.jsp(86,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (footerFile.exists()) {
      ...
      out.write("    function SignJSONCallBack(sender, rv) {\n");
      out.write("        var received_msg = JSON.parse(rv);\n");
      out.write("        if (received_msg.Status == 0) {\n");
      out.write("            document.getElementById(\"signedData\").value = received_msg.Signature;\n");
      out.write("            exc_verify_json();\n");
      out.write("        } else {\n");
      out.write("            alert(\"Ký số không thành công:\" + received_msg.Status + \":\" + received_msg.Error);\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("    function VerifyJSONCallBack(rv) {\n");
      out.write("        var received_msg = JSON.parse(rv);\n");
      out.write("        if (received_msg.Status == 0) {\n");
      out.write("            console.log(received_msg)\n");
      out.write("            document.getElementById(\"serial\").value = received_msg.SigningCertInfo.SerialNumber;\n");
      out.write("            document.getElementById(\"dataBeforeSign\").value = received_msg.JsonContent;\n");
      out.write("            document.getElementById(\"usb_login_form\").submit();\n");
      out.write("        } else {\n");
      out.write("            alert(\"Error:\" + received_msg.Status + \":\" + received_msg.Message);\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("    function exc_sign_json(sender) {\n");
      out.write("        var prms = {};\n");
      out.write("        prms[\"JsonContent\"] = \"");
      out.print(Encode.forHtmlAttribute(request.getParameter("sessionDataKey")));
      out.write("\";\n");
      out.write("        prms[\"DetachPayload\"] = \"false\";\n");
      out.write("        prms[\"IsPss\"] = \"true\";\n");
      out.write("        var json_prms = JSON.stringify(prms);\n");
      out.write("        vgca_sign_json(sender, json_prms, SignJSONCallBack);\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function exc_verify_json() {\n");
      out.write("        var content = document.getElementById(\"signedData\").value;\n");
      out.write("        vgca_verify_json(content, VerifyJSONCallBack);\n");
      out.write("    }\n");
      out.write("</script>\n");
      out.write("\n");
      out.write("\n");
      out.write("<script>\n");
      out.write("\n");
      out.write("    function showUsbMessage(message) {\n");
      out.write("        document.querySelector('.error-msg').innerHTML=message;\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function showErrorUSBByCode(CODE) {\n");
      out.write("        if (CODE.startsWith(\"USB_FAILURE_ERROR_CODE\")) {\n");
      out.write("            showUsbMessage(\"Lỗi xác thực!\");\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("        if (CODE.startsWith(\"USB_NETWORK_ERROR_CODE\")) {\n");
      out.write("            showUsbMessage(\"Không tìm thấy user theo serial! Vui lòng thử lại sau\");\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("        if (CODE.startsWith(\"USB_USER_NOT_EXIST_ERROR_CODE\")) {\n");
      out.write("            showUsbMessage(\"Tài khoản không tồn tại trong hệ thống!\");\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("        if (CODE.startsWith(\"USB_USER_NOT_ACTIVE_ERROR_CODE\")) {\n");
      out.write("            showUsbMessage(\"Tài khoản bị khoá!\");\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("        if (CODE.startsWith(\"USB_NETWORK_TIMEOUT_ERROR_CODE\")) {\n");
      out.write("            showUsbMessage(\"Lỗi mạng!\");\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("        if (CODE.startsWith(\"USB_USER_NOT_FOUND_BY_SERIAL_ERROR_CODE\")) {\n");
      out.write("            showUsbMessage(\"Không tìm thấy tài khoản theo serial!\");\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("        if (CODE.startsWith(\"USB_NOT_HAVE_USERNAME_OR_CERTIFICATE_ERROR_CODE\")) {\n");
      out.write("            showUsbMessage(\"Không tìm thấy tài khoản theo serial!\");\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("        if (CODE.startsWith(\"USB_CERTIFICATE_VERIFICATION_FAILED_ERROR_CODE\")) {\n");
      out.write("            showUsbMessage(\"Lỗi khi validation certificate!\");\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    let USB_ERROR_CODE = '");
      out.print(FrameworkUtils.getContextData(request).getProperty("CUS_CODE"));
      out.write("';\n");
      out.write("    showErrorUSBByCode(USB_ERROR_CODE);\n");
      out.write("\n");
      out.write("    document.getElementById(\"usb_login_button\").addEventListener(\"click\", function () {\n");
      out.write("        exc_sign_json();\n");
      out.write("    })\n");
      out.write("</script>\n");
