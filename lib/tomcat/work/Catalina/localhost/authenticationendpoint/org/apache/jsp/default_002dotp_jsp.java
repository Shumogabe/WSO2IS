 ...
 * Generated at: 2025-04-03 02:35:47 UTC
...
public final class default_002dotp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    layoutData.put("containerSize", "medium");
      ...
      try {
        ...
        // /default-otp.jsp(47,0) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /default-otp.jsp(47,0) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /default-otp.jsp(47,0) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /default-otp.jsp(48,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /default-otp.jsp(61,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write('\n');
                  out.write("\n");
                  out.write("            <h2>Mã OTP</h2>\n");
                  out.write("            <div class=\"ui divider hidden\"></div>\n");
                  out.write("            <div class=\"error-msg\">Vui lòng nhập mã OTP của bạn!</div>\n");
                  out.write("            <div class=\"segment-form\">\n");
                  out.write("                <form class=\"ui large form\" id=\"defaultOtpForm\" name=\"pin_form\" action=\"../commonauth\" method=\"POST\">\n");
                  ...
                  out.write("<input type=\"number\" style=\"width: 44px\" maxlength=\"1\" id=\"email_otp_");
                  out.print(i);
                  out.write('"');
                  out.write('>');
                  ...
                  out.write("'/>\n");
                  out.write("                    <input type=\"hidden\" name=\"defaultOtp\" id=\"defaultOtp\"/>\n");
                  out.write("                    <div class=\"column buttons\">\n");
                  out.write("                        <input type=\"submit\" name=\"authenticate\" id=\"authenticate\" value=\"");
            ...
            try {
              ...
              // /default-otp.jsp(92,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (footerFile.exists()) {
      ...
      out.print(FrameworkUtils.getContextData(request).getProperty("defaultOtp").toString().length());
      out.write(";\n");
      out.write("    document.getElementById('email_otp_0').focus();\n");
      out.write("    for (let i = 0; i < lengthOfOTP; i++) {\n");
      out.write("        document.getElementById('email_otp_' + i).addEventListener(\"keyup\", function (event) {\n");
      ...
      out.write("            document.getElementById('email_otp_' + (index - 1)).focus();\n");
      out.write("            document.getElementById('email_otp_' + (index - 1)).select();\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("\n");
      ...
      out.write("            document.getElementById('email_otp_' + (index + 1)).focus();\n");
      out.write("            document.getElementById('email_otp_' + (index + 1)).click();\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function getTotp() {\n");
      out.write("        let totp = \"\";\n");
      out.write("        for (let i = 0; i < lengthOfOTP; i++) totp += document.getElementById('email_otp_' + i).value;\n");
      out.write("        return totp;\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    document.querySelector('input[name=\"defaultOtp\"]').style.display = 'none';\n");
      out.write("    document.getElementById(\"defaultOtpForm\").addEventListener(\"submit\", function () {\n");
      out.write("        const tokenInput = document.querySelector('input[name=\"defaultOtp\"]');\n");
      out.write("        tokenInput.value = getTotp();\n");
      out.write("    });\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\";\n");
      out.write("    if(\"DEFAULT_OTP_AUTHENTICATION_FAILED\".includes(code)){\n");
      out.write("        document.querySelector('.error-msg').innerHTML = \"Mã xác nhận không hợp lệ. Vui lòng thử lại!\";\n");
      out.write("    }\n");
      out.write("</script>\n");
      out.write("</body>\n");
      out.write("</html>\n");
