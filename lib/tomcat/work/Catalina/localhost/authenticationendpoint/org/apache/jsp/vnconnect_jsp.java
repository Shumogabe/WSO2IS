 ...
 * Generated at: 2025-05-10 01:51:24 UTC
...
public final class vnconnect_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/wservice.jsp", Long.valueOf(1742872345000L));
  ...
  static {
    ...
    _jspx_imports_classes.add("org.wso2.carbon.identity.application.common.model.ClaimMapping");
    _jspx_imports_classes.add("java.util.Map");
    _jspx_imports_classes.add("org.wso2.carbon.identity.application.authentication.framework.model.AuthenticatedIdPData");
    ...
    _jspx_imports_classes.add("org.wso2.carbon.user.core.UserStoreManager");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    layoutData.put("containerSize", "medium");
      ...
      try {
        ...
        // /vnconnect.jsp(57,0) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /vnconnect.jsp(57,0) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /vnconnect.jsp(57,0) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /vnconnect.jsp(58,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /vnconnect.jsp(70,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (cccd == null) { 
                  out.write("\n");
                  out.write("            <h5>Không tìm thấy Căn cước công dân</h5>\n");
                  out.write("            ");
} else if (local_username == null) {
                  out.write("\n");
                  out.write("            <h5>Không tồn tại tài khoản với CCCD ");
                  out.print(cccd);
                  out.write("\n");
                  out.write("            </h5>\n");
                  out.write("            ");
                  ...
                  out.write("\n");
                  out.write("            <h4>Xác nhận thông tin lần đầu đăng nhập bằng VNCONNECT</h4>\n");
                  out.write("            <div class=\"ui divider hidden\"></div>\n");
                  out.write("            <div class=\"error-msg\"></div>\n");
                  out.write("            <div class=\"ui divider hidden\"></div>\n");
                  out.write("            <div class=\"segment-form\">\n");
                  out.write("                <form class=\"ui large form\" action=\"/commonauth\" method=\"POST\">\n");
                  out.write("                    <input id=\"sessionDataKey\" value=\"");
                  out.print(request.getParameter("sessionDataKey"));
                  out.write("\" name=\"sessionDataKey\" hidden>\n");
                  out.write("                    <input type=\"hidden\" name=\"is_vnconnect\" value=\"true\"/>\n");
                  out.write("                    <label>\n");
                  out.write("                        Căn cước công dân\n");
                  out.write("                        <input type=\"text\" value=\"");
                  out.print(cccd);
                  out.write("\" disabled readonly>\n");
                  out.write("                    </label>\n");
                  out.write("                    <label hidden>\n");
                  out.write("                        ID Vnconnect\n");
                  out.write("                        <input name=\"http://wso2.org/claims/id_vnconnect\" type=\"text\" value=\"");
                  out.print(StringUtils.trimToEmpty(vnconnect_claims.get(local_vnconnect.get("http://wso2.org/claims/id_vnconnect"))));
                  out.write("\" readonly>\n");
                  out.write("                    </label>\n");
                  out.write("                    <label>\n");
                  out.write("                        Họ và tên\n");
                  out.write("                        <input name=\"http://wso2.org/claims/fullname\" type=\"text\"\n");
                  out.write("                               value=\"");
                  out.print(getValue(vnconnect_claims.get(local_vnconnect.get("http://wso2.org/claims/fullname")),getClaimValue(vnconnectAuthenticationContext.getTenantDomain(),local_username,"http://wso2.org/claims/fullname")));
                  out.write("\"\n");
                  out.write("                               required>\n");
                  out.write("                    </label>\n");
                  out.write("                    <label>\n");
                  out.write("                        Số điện thoại\n");
                  out.write("                        <input name=\"http://wso2.org/claims/mobile\" type=\"text\"\n");
                  out.write("                               value=\"");
                  out.print(getValue(vnconnect_claims.get(local_vnconnect.get("http://wso2.org/claims/mobile")),getClaimValue(vnconnectAuthenticationContext.getTenantDomain(),local_username,"http://wso2.org/claims/mobile")));
                  out.write("\"\n");
                  out.write("                               pattern=\"^\\d{10,11}$\" required>\n");
                  out.write("                    </label>\n");
                  out.write("                    <label>\n");
                  out.write("                        Email\n");
                  out.write("                        <input name=\"http://wso2.org/claims/emailaddress\" type=\"email\"\n");
                  out.write("                               value=\"");
                  out.print(getValue(vnconnect_claims.get(local_vnconnect.get("http://wso2.org/claims/emailaddress")),getClaimValue(vnconnectAuthenticationContext.getTenantDomain(),local_username,"http://wso2.org/claims/emailaddress")));
                  out.write("\"\n");
                  out.write("                               required>\n");
                  out.write("                    </label>\n");
                  out.write("                    <div class=\"align-center buttons\">\n");
                  out.write("                        <input type=\"submit\" style=\"width: 100%\" name=\"authenticate\" id=\"usb_login_button\" value=\"Xác nhận\" class=\"ui primary button\"/>\n");
                  out.write("                    </div>\n");
                  out.write("                </form>\n");
                  out.write("            </div>\n");
                  out.write("            ");
                  ...
                  out.write("\n");
                  out.write("            <h5>Đang đăng nhập bằng VNCONNECT ...</h5>\n");
                  out.write("            <form class=\"ui large form\" action=\"/commonauth\" method=\"POST\" id=\"skip_form\">\n");
                  out.write("                <input id=\"sessionDataKey\" value=\"");
                  out.print(request.getParameter("sessionDataKey"));
                  out.write("\" name=\"sessionDataKey\" hidden>\n");
                  out.write("                <input type=\"hidden\" name=\"is_vnconnect\" value=\"true\"/>\n");
            ...
            try {
              ...
              // /vnconnect.jsp(133,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (footerFile.exists()) {
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("    document.getElementById(\"skip_form\").submit();\n");
      out.write("</script>\n");
