...
public final class smsOtp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    layoutData.put("containerSize", "medium");
      ...
      try {
        ...
        // /smsOtp.jsp(405,0) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /smsOtp.jsp(405,0) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /smsOtp.jsp(405,0) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /smsOtp.jsp(406,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /smsOtp.jsp(419,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (request.getParameter("screenvalue") != null) { 
                  ...
                  out.print(IdentityManagementEndpointUtil.i18n(resourceBundle, "enter.code.sent.smsotp"));
                  out.write("<span>: <b>");
                  out.print(encodeMobileNumber(mobileNumber));
                  out.write("</b></span>\n");
                  out.write("                            </label>\n");
                  out.write("                            <input type=\"password\" id='OTPcode' name=\"OTPcode\"\n");
                  out.write("                                   size='30'/>\n");
                  ...
                  out.write("'/><br/>\n");
                  out.write("                        <div class=\"align-right buttons\" style=\"display: flex; justify-items: center; flex-direction: column-reverse\">\n");
                  out.write("                            ");
                  ...
                  out.write("\n");
                  out.write("                            <div\n");
                  out.write("                                    style=\"margin: auto; padding-top: 15px;\"\n");
                  out.write("                                    id=\"resendCodeLinkDiv\"\n");
                  out.write("                                    tabindex=\"0\"\n");
                  out.write("                                    onclick=\"resendOtp()\"\n");
                  out.write("                                    onkeypress=\"javascript: if (window.event.keyCode === 13) resendOtp()\">\n");
                  out.write("                                Bạn chưa nhận được mã OTP? <a id=\"resend\" style=\"cursor: pointer\">");
                  ...
                  out.write("                                    type=\"submit\" name=\"authenticate\" id=\"authenticate\"\n");
                  out.write("                                    value=\"");
            ...
            try {
              ...
              // /smsOtp.jsp(511,4) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (footerFile.exists()) {
      ...
      out.write("            $('#pin_form').on('submit', function (e) {\n");
      ...
      out.write("            });\n");
      out.write("        };\n");
      out.write("        $('#pin_form').preventDoubleSubmission();\n");
      out.write("    });\n");
      out.write("\n");
      ...
      out.print(getOtpToken(request).length() );
      out.write(";\n");
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    document.querySelector('input[name=\"OTPcode\"]').style.display = 'none';\n");
      out.write("    document.getElementById(\"pin_form\").addEventListener(\"submit\", function () {\n");
