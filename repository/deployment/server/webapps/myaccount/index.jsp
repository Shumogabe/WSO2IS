<!--
* Copyright (c) 2022, VNPT IDPLLC. (https://www.wso2.com). All Rights Reserved.
*
* VNPT IDPLLC. licenses this file to you under the Apache License,
    ...
    <head>
        <script>
            ...
            if (isSignOutSuccess && userTenant) {
                window.location.href = applicationDomain + "/t/" + userTenant + "/" + "myaccount";
